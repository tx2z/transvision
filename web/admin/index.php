...
<html>
	<head>
		...
		<meta charset="utf-8"/>
		<script type="text/javascript" src="/admin/js/sha1.js"></script>
		<script type="text/javascript" src="/admin/js/user.js"></script>
		<link rel="stylesheet" type="text/css" href="/admin/style.css"></link>
	</head>
...
<?php		if(!$USER->authenticated) { ?>
			...
			<form class="controlbox" name="new user registration" id="registration" action="/admin/index.php" method="POST">
...
<?php 		}
			...
			<form class="controlbox" name="log in" id="login" action="/admin/index.php" method="POST">
...
<?php 		}
			...
			<form class="controlbox" name="forgotten passwords" id="reset" action="/admin/index.php" method="POST">
...
<?php 		}
			...
			<!-- Log out option -->
			<form class="controlbox" name="log out" id="logout" action="/admin/index.php" method="POST">
...
<?php 		}
			...
			<form class="controlbox" name="update" id="update" action="/admin/index.php" method="POST">
...
<?php 		}
			...
			<form class="controlbox" name="unregister" id="unregister" action="/admin/index.php" method="POST">
